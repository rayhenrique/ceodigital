<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('demanda-reprimida.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-slate-300 rounded-lg font-semibold text-xs text-slate-700 uppercase tracking-widest hover:bg-slate-50 transition shadow-xs">
                Voltar à Fila
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-xs p-6 sm:p-8">
                <form method="POST" action="{{ route('demanda-reprimida.store') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div x-show="pacienteIdSelecionado" class="p-3 bg-purple-50 border border-purple-200 rounded-lg text-xs flex items-center justify-between">
                            <div>
                            ...
                            <button type="button" @click="pacienteIdSelecionado = null; pacienteNomeSelecionado = ''" class="text-rose-600 hover:text-rose-800 font-bold">Alterar</button>
                        </div>
