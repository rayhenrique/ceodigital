<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Cadastre o profissional especialista e configure sua grade semanal de turnos
                </p>
            </div>
            <a href="{{ route('dentistas.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-slate-300 rounded-lg font-semibold text-xs text-slate-700 uppercase tracking-widest hover:bg-slate-50 transition shadow-xs">
                Voltar à Lista
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-8" x-data="{
        grades: [
            { dia_semana: 1, turno: 'manha', vagas_padrao: 8 }
        ],
        adicionarGrade() {
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl border border-slate-200 shadow-xs p-6 sm:p-8">
                <form method="POST" action="{{ route('dentistas.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" id="nome_completo" name="nome_completo" value="{{ old('nome_completo') }}" required placeholder="Ex: Dr. Carlos Eduardo Medeiros" class="w-full rounded-lg border-slate-300 text-sm focus:border-teal-500 focus:ring-teal-500">
                            ...
                            <div>
                                ...
                                <input type="text" id="cro" name="cro" value="{{ old('cro') }}" required placeholder="Ex: CRO-AL 1234" class="w-full rounded-lg border-slate-300 text-sm font-mono focus:border-teal-500 focus:ring-teal-500">
                            ...
                            <div>
                                ...
                                <input type="text" id="telefone" name="telefone" value="{{ old('telefone') }}" placeholder="(82) 98888-7777" class="w-full rounded-lg border-slate-300 text-sm focus:border-teal-500 focus:ring-teal-500">
