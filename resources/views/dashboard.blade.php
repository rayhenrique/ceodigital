                                    ...
                                    <tr class="hover:bg-slate-50/80 transition">
                                        ...
                                        <td class="px-4 py-3 text-right whitespace-nowrap">
                                            <div class="flex items-center justify-end gap-1.5">
                                                ...
                                                <a href="{{ route('agenda.index', ['data' => $agendamento->data->format('Y-m-d'), 'dentista_id' => $agendamento->dentista_id]) }}" class="p-1 text-slate-400 hover:text-slate-700 transition" title="Ver detalhes na grade">
